		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#hrzlgsampleodata-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"hrzlgsampleodata-display": {
								"semanticObject": "hrzlgsampleodata",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=hr.zlgsampleodata",
									"url": sap.ui.require.toUrl("hr/zlgsampleodata")
								}
							}
						}
					}
